...
export function getPublishedQuestions(questions: Question[]): Question[] {
    return deepCopyQuestions(questions).filter(
...
export function findQuestion(
    ...
    let question = questions.find((question: Question) => question.id === id);
...
export function sumPublishedPoints(questions: Question[]): number {
    return questions
        ...
        .reduce(
            (current: number, question: Question) =>
...
export function toCSV(questions: Question[]): string {
    return questions.reduce(
        (current: string, question: Question) =>
...
export function publishAll(questions: Question[]): Question[] {
    return deepCopyQuestions(questions).map((question: Question) => ({
        ...question,
        published: true,
    }));
}
...
export function sameType(questions: Question[]): boolean {
    ...
    return questions.every((question: Question) => question.type === type);
}
...
export function addNewQuestion(
    ...
    return [...deepCopyQuestions(questions), makeBlankQuestion(id, name, type)];
}
...
export function editOption(
    ...
    let newQuestions: Question[] = deepCopyQuestions(questions);
    let question: Question | undefined = newQuestions.find(
